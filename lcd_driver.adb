...
--   pragma Volatile (Update_Is_Required);
   ...
   procedure Init is
      ...
      for LCD_Control_Status_A'Address use LCDCRA'Address;

      LCD_Control_Status_B : AVR.Bits_In_Byte;
      for LCD_Control_Status_B'Address use LCDCRB'Address;

      Frame_Rate_Reg : AVR.Bits_In_Byte;
      for Frame_Rate_Reg'Address use LCDFRR'Address;
   ...
   begin
      ...
      --  UART.Put("Symbol for ");
      --  UART.Put(Character(C));
      --  UART.Put(": ");
      --  UART.Put(Unsigned_16(Seg));
      --  UART.New_Line;
   ...
   begin
--      UART.Put_Line("In LCD Interrupt");
...
--         LCD_Registers := LCD_Data;
   ...
   procedure Set_Contrast_Level (Level : Contrast_Level) is
      ...
      for LCDCCR_Reg'Address use LCDCCR'Address;
   begin
